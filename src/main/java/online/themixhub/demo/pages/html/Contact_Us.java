...
public class Contact_Us {
	...
	//for when we use SQL
	@Inject
	public Contact_Us(DataSource ds) {
		this.ds = ds;
	}
	...
	public Result getPage(Request req) throws IOException {
		...
		if (!req.session().isSet("set")) {
			...
			Result result = Results.html("dashboard_page_template").
					put("content", "Contact Us page coming soon.").
					put("title", "The Mix Hub Online - Contact Us").
					put("breadcrumb", BreadCrumbs.instance().href("/dashboard", "Dashboard").title("Contact Us")).
