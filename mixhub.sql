...
CREATE TABLE `jobs` (
  ...
  `anonymous_engineer` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `jobs` VALUES (1,1,7,'ewgwe',1491190463144,1,NULL),(2,6,7,'My Shit Song',1491214914968,99,NULL),(3,9,7,'Test Job',1491263980176,99,NULL),(4,10,NULL,'aaa',1491271981461,0,NULL),(5,12,NULL,'eg want good shit',1491277235319,0,NULL),(6,1,NULL,'cool man',1491278901853,0,NULL),(7,6,7,'another shit song',1491279012381,1,NULL),(8,6,7,'anotehr one',1491279200782,98,NULL);
...
-- Dump completed on 2017-04-04  0:37:23
